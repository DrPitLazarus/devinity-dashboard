            ...
            <div class="media-content">
                ...
                <div class="level is-marginless">
                    ...
                    <div v-if="achieve.value != -1" class="level-right is-marginless has-text-right">
                        <p>{{ achieve.value }} of {{ achieve.goal || 1 }}</p>
                    </div>
                </div>
                <progress v-if="achieve.value != -1" class="progress" :value="achieve.value" :max="achieve.goal || 1"></progress>
            </div>
...
export default {
    ...
    methods: {
        ...
        getData() {
            this.isLoading = true
            this.$http.get(apiPlayerPath + this.$route.params.steamId64 + '/battleroyaleAchievements')
            .then(res => {
                this.data = res.data
